...
ev16 <- ggplot() +
   geom_sf(data = us_geo) + 
   geom_sf(data = d_ev_transformed |> filter(year == 2016), aes(color = party), size = 1, alpha = 0.5, pch = 16) +
   ggtitle("2016 Campaign Events") +
   theme_void()

ev20 <- ggplot() +
   geom_sf(data = us_geo) + 
   geom_sf(data = d_ev_transformed |> filter(year == 2020), aes(color = party), size = 1, alpha = 0.5, pch = 16) +
   ggtitle("2020 Campaign Events") +
   theme_void()

ev24 <- ggplot() +
   geom_sf(data = us_geo) + 
   geom_sf(data = d_ev_transformed |> filter(year == 2024), aes(color = party), size = 1, alpha = 0.5, pch = 16) +
