...
us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradient2(high = "#00008B", mid = "#FFFFFF", low = "#8B0000", midpoint = 0, 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Television Ad Partisan Advantage by State in 2000",
...
us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradient2(high = "#00008B", mid = "#FFFFFF", low = "#8B0000", midpoint = 0, 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Television Ad Partisan Advantage by State in 2004",
    fill = "Spending Advantage ($)",
       caption = "Advertisement Data source: Wesleyan Media Project")
...
us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradient2(high = "#00008B", mid = "#FFFFFF", low = "#8B0000", midpoint = 0, 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Television Ad Partisan Advantage by State in 2008",
    fill = "Spending Advantage ($)",
       caption = "Advertisement Data source: Wesleyan Media Project")
...
us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradient2(high = "#00008B", mid = "#FFFFFF", low = "#8B0000", midpoint = 0, 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Television Ad Partisan Advantage by State in 2012",
    fill = "Spending Advantage ($)",
       caption = "Advertisement Data source: Wesleyan Media Project")
...
us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradient2(high = "#00008B", mid = "#FFFFFF", low = "#8B0000", midpoint = 0, 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Television Ad Partisan Advantage by State in 2020",
    fill = "Spending Advantage ($)",
       caption = "Advertisement Data source: Wesleyan Media Project")
```
