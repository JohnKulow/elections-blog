...
total_state_ad_plot_2000 <- us_hexgrid |> 
  ...
  labs(title = "Total Television Ad Spending by State in 2000",
       fill = "Total Spending",
...
total_state_ad_plot_2004 <- us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradientn(colors = c('#FFFFFF','#fee6ce','#fdd0a2','#fdae6b','#fd8d3c','#f16913','#d94801','#a63603','#7f2704'), 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Total Television Ad Spending by State in 2004",
       fill = "Total Spending",
       caption = "Advertisement Data source: Wesleyan Media Project")
...
total_state_ad_plot_2008 <- us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradientn(colors = c('#FFFFFF','#fee6ce','#fdd0a2','#fdae6b','#fd8d3c','#f16913','#d94801','#a63603','#7f2704'), 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Total Television Ad Spending by State in 2008",
       fill = "Total Spending",
       caption = "Advertisement Data source: Wesleyan Media Project")
...
total_state_ad_plot_2012 <- us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradientn(colors = c('#FFFFFF','#fee6ce','#fdd0a2','#fdae6b','#fd8d3c','#f16913','#d94801','#a63603','#7f2704'), 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Total Television Ad Spending by State in 2012",
       fill = "Total Spending",
       caption = "Advertisement Data source: Wesleyan Media Project")
...
total_state_ad_plot_2020 <- us_hexgrid |> 
  ...
  geom_sf_text(aes(label = iso3166_2)) +
   scale_fill_gradientn(colors = c('#FFFFFF','#fee6ce','#fdd0a2','#fdae6b','#fd8d3c','#f16913','#d94801','#a63603','#7f2704'), 
                       labels = label_number()) +
  coord_sf(xlim = c(bbox["xmin"], bbox["xmax"]), ylim = c(bbox["ymin"], bbox["ymax"]), expand = FALSE) +
  labs(title = "Total Television Ad Spending by State in 2020",
       fill = "Total Spending",
       caption = "Advertisement Data source: Wesleyan Media Project")
```

```{r}
total_state_ad_plot_2000
total_state_ad_plot_2004
total_state_ad_plot_2008
total_state_ad_plot_2012
...
state_ad_plot_margin_2000 <- us_hexgrid |> 
  ...
  labs(title = "2000",
    ...
    x = "",
    y = "") +
  theme(legend.position = "none",axis.text.x = element_blank(),  # Remove x-axis tick labels
...
```{r}
state_ad_plot_margin_2000+state_ad_plot_margin_2004
...
```{r}
diff_vote_model <- lm(D_pv2p ~ spending_diff, 
   data = ads_vote_merged)

diff_vote_model2 <- lm(D_pv2p ~ spending_diff + D_pv2p_lag1, 
   data = ads_vote_merged)

diff_shift_model <- lm(D_pv2p_shift1 ~ spending_diff, 
   data = ads_vote_merged)
